...
@section('title','Yeni Yazı Oluştur - Yeşil Toprak')
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    <h1 class="h2 mb-1" style="color: var(--primary-green);">
                        <i class="fas fa-edit me-2"></i>Yeni Yazı Oluştur
                    </h1>
                    <p class="text-muted mb-0">Organik tarım hakkında yeni bir blog yazısı oluşturun</p>
                </div>
            </div>
        </div>
...
<div class="admin-form-container">
    <form method="POST" action="{{ route('admin.posts.store') }}" class="row g-4">
        @csrf
        ...
        <div class="col-12">
            ...
            <input name="title" class="form-control form-control-lg" placeholder="Yazı başlığını girin..." value="{{ old('title') }}">
            @error('title')
        ...
        <div class="col-12">
            ...
            <input name="excerpt" class="form-control" placeholder="Yazının kısa özetini girin..." value="{{ old('excerpt') }}">
            @error('excerpt')
                <div class="text-danger small mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-12">
            ...
            <textarea name="content" class="form-control" rows="12" placeholder="Yazı içeriğini buraya yazın...">{{ old('content') }}</textarea>
            @error('content')
                <div class="text-danger small mt-1">{{ $message }}</div>
            @enderror
        </div>
            ...
            <div class="card border-0 bg-light">
                <div class="card-body">
                    ...
                    <small class="text-muted">
                        Bu seçeneği işaretlerseniz yazı hemen yayınlanır. Aksi takdirde taslak olarak kaydedilir.
                    </small>
                </div>
            </div>
        </div>
